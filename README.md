...
Includes autocompletion, aliases, custom functions, a few stolen pieces from Steve Losh, and more.
...
1. Check out a clone of this repo to a location of your choice, such as: `git clone --depth=1 https://github.com/nemofang/bash-it ~/.bash-it`
2. Run `~/.bash-it/install.sh --interactive` (it automatically backs up your `~/.bash_profile` or `~/.bashrc`, depending on your OS)
